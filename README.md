...
<div><span><b>00 · SYNTHETIC-BIOLOGY</b> · INSILICO · METABOLIC PATHWAYS</span><span>LIVE LANE · 173000Z</span></div>
...
<sub>02 · Synthetic Biology animated mechanics diagram · b-cell b-codec-mechanics cell-5 row-2</sub>
<figure>
...
<div><b>02 · MARKETS</b><span>USER FIT</span></div>
      <div>
        <div>
          <div><span>Design-toolchain QA</span><span></span><span>primary</span></div>
          <div><span>SBOL / design packets</span><span></span><span>fit</span></div>
          <div><span>Pre-wet-lab review</span><span></span><span>bounded</span></div>
          <div><span>Computational biology QA</span><span></span><span>adjacent</span></div>
          <div><span>Biofoundry intake</span><span></span><span>future</span></div>
        </div>
      </div>
...
<div><b>05.2 · BENCHMARKS</b><span>STRUCTURAL &middot; COMMITTED PACKETS</span></div>
      <div>
        ...
        <div>
          <div><span>structural check</span><span></span><span>3/3 PASS</span></div>
          <div><span>scientific HMO</span><span></span><span>false</span></div>
          <div><span>release wording</span><span></span><span>stale</span></div>
        </div>
      </div>
...
<div><b>06.1 · COMPARATIVE / BOUNDED VALIDATION &middot; STRUCTURAL VS SCIENTIFIC STATUS</b></div>
      <div>
        <div>
          <div><span>structural check</span><span></span><span>3/3 PASS &middot; HMO triple</span></div>
          <div><span>CPU test suite</span><span></span><span>256 PASS &middot; 0 regressions</span></div>
          <div><span>scientific HMO validation</span><span></span><span>false &middot; committed packet</span></div>
          <div><span>public release wording</span><span></span><span>stale v0.1.0</span></div>
        </div>
      </div>
